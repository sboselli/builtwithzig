...
export function Footer() {
  ...
  const handleFeedbackSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:sboselli@gmail.com?subject=Built with Zig Feedback&body=${encodeURIComponent(feedback)}`;
    ...
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-12 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://github.com/sboselli"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="mailto:sboselli@gmail.com"
                className="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                href="https://github.com/sboselli/builtwithzig/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://buymeacoffee.com/sboselli"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700 text-center text-sm text-gray-500 dark:text-gray-400">
          <p>© {new Date().getFullYear()} Built with Zig. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
